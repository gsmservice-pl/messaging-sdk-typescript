...
import { accountsGetSubaccountDetails } from "../../funcs/accountsGetSubaccountDetails.js";
...
export const tool$accountsGetSubaccountDetails: ToolDefinition<typeof args> = {
  name: "accounts-get-subaccount-details",
...
As a successful result a \`AccountResponse\` object will be returned with properties describing details of subaccount with provided login.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await accountsGetSubaccountDetails(
      client,
      args.request,
